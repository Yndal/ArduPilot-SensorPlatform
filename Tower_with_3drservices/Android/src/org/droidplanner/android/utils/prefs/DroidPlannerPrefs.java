...
public class DroidPlannerPrefs {
	...
	public static final String DEFAULT_SENSOR_UPDATE_INTERVAL = "5"; //Must be in seconds
	public static final String DEFAULT_SENSOR_MEASURING_TIME = "1"; //Must be in seconds
	public static final double DEFAULT_HEAT_MAP_ALTITUDE = 20.0;
	public static final int DEFAULT_HEAT_MAP_GRANULARITY = 5;
	public static final double DEFAULT_HEAT_MAP_SPEED_M_S = 5.0;
    ...
    //TODO Sensor stuff settings
	public int getSensorUpdateInterval(){
		String interval = prefs.getString(context.getString(R.string.sensor_update_interval_key), DEFAULT_SENSOR_UPDATE_INTERVAL);
		return Integer.parseInt(interval);
	}
	public void setSensorUpdateInterval(int seconds){
		prefs.edit().putString(context.getString(R.string.sensor_update_interval_key),
				String.valueOf(seconds)).apply();
	}

	public int getSensorMeasuringTime(){
		String interval = prefs.getString(context.getString(R.string.sensor_measuring_time_key), DEFAULT_SENSOR_MEASURING_TIME);
		return Integer.parseInt(interval);
	}
	public void setSensorMeasuringTime(int seconds){
		prefs.edit().putString(context.getString(R.string.sensor_measuring_time_key),
				String.valueOf(seconds)).apply();
	}

	public double setHeatMapAltitude(){
		double altitude = Double.valueOf(prefs.getString(context.getString(R.string.pref_sensor_platform_heat_map_altitude_key), String.valueOf(DEFAULT_HEAT_MAP_ALTITUDE)));
		return altitude;
	}
	public void setHeatMapAltitude(double alt){
		prefs.edit().putString(context.getString(R.string.pref_sensor_platform_heat_map_altitude_key),
				String.valueOf(alt)).apply();
	}

	public int getHeatMapGranularity(){
		int granularity = Integer.valueOf(prefs.getString(context.getString(R.string.pref_sensor_platform_heat_map_granularity_key), String.valueOf(DEFAULT_HEAT_MAP_GRANULARITY)));
		return granularity;
	}
	public void setHeatMapGranularity(int granularity){
		prefs.edit().putString(context.getString(R.string.pref_sensor_platform_heat_map_granularity_key),
				String.valueOf(granularity)).apply();
	}

	public double getHeatMapSpeedMetersPerSecond(){
		double speed = Double.valueOf(prefs.getString(context.getString(R.string.pref_sensor_platform_heat_map_speed_key), String.valueOf(DEFAULT_HEAT_MAP_SPEED_M_S)));
		return speed;
	}
	public void setHeatMapSpeedMetersPerSecond(double mPerS){
		prefs.edit().putString(context.getString(R.string.pref_sensor_platform_heat_map_speed_key),
				String.valueOf(mPerS)).apply();
	}
