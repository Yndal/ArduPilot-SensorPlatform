...
import org.droidplanner.core.drone.variables.FloatSensor;
...
import org.droidplanner.core.drone.variables.IntSensor;
...
public class DroneImpl implements Drone {
    ...
    private final IntSensor intSensor; //TODO Sensor stuff
    private final FloatSensor floatSensor; //TODO Sensor stuff
	...
	public DroneImpl(MAVLinkStreams.MAVLinkOutputStream mavClient, DroneInterfaces.Clock clock,
        ...
        //TODO Sensor stuff
        this.intSensor = new IntSensor(this);
        this.floatSensor = new FloatSensor(this);
        this.RC = new RC(this);
    ...
    @Override
    public IntSensor getIntSensor(){ //TODO Sensor stuff
        return intSensor;
    }
    @Override
    public FloatSensor getFloatSensor(){ //TODO Sensor stufff
        return floatSensor;
    } //TODO Sensor stuff
