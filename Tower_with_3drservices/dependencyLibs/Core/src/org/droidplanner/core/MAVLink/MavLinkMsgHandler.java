...
public class MavLinkMsgHandler {
	...
	public void receiveData(MAVLinkMessage msg) {
		...
		switch (msg.msgid) {
            //TODO Added sensor stuff here
            case msg_int_sensor.MAVLINK_MSG_ID_INT_SENSOR:
                msg_int_sensor intSensor = (msg_int_sensor) msg;
                drone.getIntSensor().setIntSensor(intSensor);
                break;
            case msg_float_sensor.MAVLINK_MSG_ID_FLOAT_SENSOR:
                msg_float_sensor floatSensor = (msg_float_sensor) msg;
                drone.getFloatSensor().setFloatSensor(floatSensor);
                break;
