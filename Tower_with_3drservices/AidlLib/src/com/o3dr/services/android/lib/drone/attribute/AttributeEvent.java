...
public class AttributeEvent {
     ...
     * For sensor stuff
     **************/
    //TODO For sensor stuff
    public static final String INT_SENSOR_UPDATED = PACKAGE_NAME + ".INT_SENSOR_UPDATED";
    public static final String FLOAT_SENSOR_UPDATED = PACKAGE_NAME + ".FLOAT_SENSOR_UPDATED";
