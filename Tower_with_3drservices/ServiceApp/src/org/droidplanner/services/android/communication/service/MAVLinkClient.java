...
public class MAVLinkClient implements MAVLinkStreams.MAVLinkOutputStream {
    ...
    public void openConnection() {
        ...
        final String tag = super.toString();
    ...
    public boolean isConnected() {
        return this.connParams != null
                && mavLinkApi.getConnectionStatus(this.connParams, super.toString()) == MavLinkConnection.MAVLINK_CONNECTED;
    }

    public boolean isConnecting(){
        return this.connParams != null && mavLinkApi.getConnectionStatus(this.connParams,
                super.toString()) == MavLinkConnection.MAVLINK_CONNECTING;
    }
