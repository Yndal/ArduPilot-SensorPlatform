...
public class Drone {
    ...
    private <T extends Parcelable> T getAttributeDefaultValue(String attributeType) {
        switch (attributeType) {
            ...
            case AttributeType.INT_SENSOR:
                return (T) new IntSensor();
            case AttributeType.FLOAT_SENSOR:
                return (T) new FloatSensor();
    ...
    private ClassLoader getAttributeClassLoader(String attributeType) {
        switch (attributeType) {
            //TODO SENSOR STUFF
            case AttributeType.INT_SENSOR:
                return IntSensor.class.getClassLoader();
            case AttributeType.FLOAT_SENSOR:
                return FloatSensor.class.getClassLoader();
    ...
    public void sendMavlinkMessage(MavlinkMessageWrapper messageWrapper) { //TODO Send MAVLink message
