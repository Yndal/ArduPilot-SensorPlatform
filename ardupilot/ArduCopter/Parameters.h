...
public:
    ...
    enum {
        ...
        k_param_teensy_sen_f,           // 63 Teensy sensor platform - read frequency
        k_param_teensy_sen_t,           // 64 Teensy sensor platform - time to perform measurement
    ...
    //Teensy sensor platorm - update frequency and time need to do measurement
    AP_Int16        teensy_sen_f;
    AP_Int16        teensy_sen_t;
